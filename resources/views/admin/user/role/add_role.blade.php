                    ...
                    <form role="form" method="post">
                        ...
                        <div class="col-md-6">
                            <div class="form-group{{ $errors->has('role_name') ? ' has-error' : '' }}">
                                ...
                                <input type="name" class="form-control" id="rolename" placeholder="Nhập tên nhóm người dùng" name="role_name" value="{{old('rolename')}}">
                            ...
                            <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                ...
                                <input class="form-control" type="text" id="description" placeholder="Nhập mô tả" name="description" value="{{old('description')}}">
